...
def print_object_types():
    ...
    for line in tabulate(grouped, headers="firstrow", tablefmt="github").splitlines():
        print(line)
    print("")
    ...
    for line in tabulate(single, headers="firstrow", tablefmt="github").splitlines():
        print(line)
    print("")
...
def print_aggregated_status():
    ...
    for line in tabulate(agg_status, headers="firstrow", tablefmt="github").splitlines():
        print(line)
    print("")
    ...
    for line in tabulate(state_bits, headers="firstrow", tablefmt="github").splitlines():
        print(line)
    print("")
...
def print_alarms():
    ...
    for object_name,object in yaml_sxl['objects'].items():
        for alarm_id,alarm in object['alarms'].items():
            alarm_table.append([object_name, '[' + alarm_id + '](#'+ alarm_id.lower() + ')', alarm['description'].splitlines()[0], alarm['priority'], alarm['category']])
    ...
    for line in tabulate(alarm_table, headers="firstrow", tablefmt="github").splitlines():
        print(line)
    print("")
    ...
    for object_name,alarm_id,description,priority,category in alarms:
        ...
        if return_values:
            ...
            for line in tabulate(return_values, headers="firstrow", tablefmt="grid").splitlines():
                print(line)
            print("")
...
def print_status():
    ...
    for object_name,object, in yaml_sxl['objects'].items():
        for status_id,status in object['statuses'].items():
            status_table.append([object_name, '[' + status_id + '](#' + status_id.lower() + ')', status['description'].splitlines()[0]])
    ...
    for line in tabulate(status_table, headers="firstrow", tablefmt="github").splitlines():
        print(line)
    print("")
    ...
    for object_name,status_id,description in statuses:
        ...
        if return_values:
            ...
            for name in array_values:
                ...
                for line in tabulate(array_values[name], headers="firstrow", tablefmt="grid").splitlines():
                    print(line)
                print("")
...
def print_commands():
    ...
    for object_name,object, in yaml_sxl['objects'].items():
        for command_id,command in object['commands'].items():
            command_table.append([object_name, '[' + command_id + '](#' + command_id.lower() + ')', command['command'], command['description'].splitlines()[0]])
    ...
    for line in tabulate(command_table, headers="firstrow", tablefmt="github").splitlines():
        print(line)
    print("")
    ...
    for object_name,command_id,description in commands:
        ...
        if arguments:
            ...
            for line in tabulate(arguments, headers="firstrow", tablefmt="grid").splitlines():
                print(line)
            print("")

parser = argparse.ArgumentParser(description='Convert SXL in yaml to markdown format')
